...
| Normal | `Space ff`    | Telescope: find any file in the project          |
| Normal | `Space fb`    | Telescope: find bufffers                         |
| Normal | `Ctrl+P`      | Telescope: find file tracked by git              |
| Normal | `Space fs`    | Telescope: grep for a string (prompts for input) |
| Normal | `Space fg`    | Telescope: live grep for a string                |
